...
export enum AppActionsTypes {
  ...
  SET_TRANSACTION_GROUPS = 'set_transaction_groups',
  SET_TRANSACTION_LOADING_ERROR = 'set_transaction_loading_error',
  ...
  LOAD_AMAZON_TRANSACTION_LIST_SAGA = 'load_amazon_transaction_list_saga'
}
// -------------------------------------------------------------------------------------
