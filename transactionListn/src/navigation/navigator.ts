...
import { IGenericError, IGlobalError } from '@models/app/errors.model';
...
export class Navigator {
  ...
  private static async reportNavigationError(stackTraceCapturer: Error, message: string): Promise<any> {
    const globalError: IGlobalError = {} as IGlobalError;
    globalError.source = ErrorSource.NAVIGATION_MODULE;
    globalError.stackTraceCapturer = stackTraceCapturer;
