...
import { TransactionDetailScreen } from '@screens/transaction-detail/transaction-detail.screen';
export class NavigationInitializer {
  ...
  public static init(): void {
    ...
    NavigationInitializer.registerComponent(ScreenRoute.TRANSACTION_DETAIL_SCREEN, gestureHandlerRootHOC(TransactionDetailScreen));
